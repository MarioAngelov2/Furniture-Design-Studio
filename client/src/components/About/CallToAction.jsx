...
function CallToAction() {
    return (
        <div id="press" className="flex justify-center md:flex md:justify-center items-center md:max-w-[1440px] h-[576px] mx-auto bg-[#F6F4F1] mt-20">
            <div className="flex flex-col w-[60%] md:flex md:flex-col items-center gap-6 md:w-[35%]">
                <h1 className="text-2xl md:text-3xl text-center font-playfair leading-normal">
                    Redefining minimalist design for your own home
                </h1>
                <p className="text-center text-base tracking-wider font-barlow">
