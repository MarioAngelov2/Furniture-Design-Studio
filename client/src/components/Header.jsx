...
function Header() {
    return (
        <div className="flex flex-col items-center justify-center px-6 md:px-20 py-8">
            <div className="mb-4 md:mb-0">
                <img src={heroImage} alt="" className="max-w-full h-auto mt-14 md:mt-0" />
            </div>
            <div className="flex flex-col items-center text-center gap-4 mt-2 md:mt-14">
                ...
                <p className="text-sm mt-2 md:text-lg">
                    Shaping the essence of living into precisely crafted spaces <br />
